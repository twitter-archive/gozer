...
type Launch struct {
	...
	ExecutorInfo     *mesos.ExecutorInfo `protobuf:"bytes,3,opt,name=executor_info" json:"executor_info,omitempty"`
	Directory        *string             `protobuf:"bytes,4,opt,name=directory" json:"directory,omitempty"`
	User             *string             `protobuf:"bytes,5,opt,name=user" json:"user,omitempty"`
	SlaveId          *mesos.SlaveID      `protobuf:"bytes,6,opt,name=slave_id" json:"slave_id,omitempty"`
...
func (m *Launch) GetContainerId() *mesos.ContainerID {
	if m != nil {
...
func (m *Launch) GetTaskInfo() *mesos.TaskInfo {
	if m != nil {
		return m.TaskInfo
	}
	return nil
...
func (m *Launch) GetExecutorInfo() *mesos.ExecutorInfo {
	if m != nil {
...
func (m *Launch) GetSlaveId() *mesos.SlaveID {
	if m != nil {
		return m.SlaveId
	}
	return nil
...
func (m *Update) GetContainerId() *mesos.ContainerID {
	if m != nil {
		return m.ContainerId
	}
	return nil
...
func (m *Update) GetResources() []*mesos.Resource {
	if m != nil {
		return m.Resources
	}
	return nil
...
func (m *Wait) GetContainerId() *mesos.ContainerID {
	if m != nil {
		return m.ContainerId
	}
	return nil
...
func (m *Destroy) GetContainerId() *mesos.ContainerID {
	if m != nil {
		return m.ContainerId
	}
	return nil
...
func (m *Usage) GetContainerId() *mesos.ContainerID {
	if m != nil {
		return m.ContainerId
	}
	return nil
...
func (m *Containers) GetContainers() []*mesos.ContainerID {
	if m != nil {
		return m.Containers
	}
	return nil
