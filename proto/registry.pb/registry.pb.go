...
type Registry_Master struct {
	Info             *mesos.MasterInfo `protobuf:"bytes,1,req,name=info" json:"info,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
func (m *Registry_Master) GetInfo() *mesos.MasterInfo {
	if m != nil {
		return m.Info
	}
	return nil
...
type Registry_Slave struct {
	Info             *mesos.SlaveInfo `protobuf:"bytes,1,req,name=info" json:"info,omitempty"`
	XXX_unrecognized []byte           `json:"-"`
}
...
func (m *Registry_Slave) GetInfo() *mesos.SlaveInfo {
	if m != nil {
		return m.Info
	}
	return nil
