...
func (m *Event_Registered) GetFrameworkId() *mesos.FrameworkID {
	if m != nil {
...
func (m *Event_Registered) GetMasterInfo() *mesos.MasterInfo {
	if m != nil {
		return m.MasterInfo
	}
	return nil
...
func (m *Event_Reregistered) GetFrameworkId() *mesos.FrameworkID {
	if m != nil {
		return m.FrameworkId
	}
	return nil
...
func (m *Event_Reregistered) GetMasterInfo() *mesos.MasterInfo {
	if m != nil {
		return m.MasterInfo
	}
	return nil
...
func (m *Call) GetFrameworkInfo() *mesos.FrameworkInfo {
	if m != nil {
...
type Call_Launch struct {
	TaskInfos        []*mesos.TaskInfo `protobuf:"bytes,1,rep,name=task_infos" json:"task_infos,omitempty"`
	OfferIds         []*mesos.OfferID  `protobuf:"bytes,2,rep,name=offer_ids" json:"offer_ids,omitempty"`
...
func (m *Call_Launch) GetTaskInfos() []*mesos.TaskInfo {
	if m != nil {
		return m.TaskInfos
	}
	return nil
...
func (m *Call_Launch) GetOfferIds() []*mesos.OfferID {
	if m != nil {
		return m.OfferIds
	}
	return nil
...
func (m *Call_Launch) GetFilters() *mesos.Filters {
	if m != nil {
		return m.Filters
	}
	return nil
...
func (m *Call_Reconcile) GetStatuses() []*mesos.TaskStatus {
	if m != nil {
		return m.Statuses
	}
	return nil
